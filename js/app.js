(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".albums__slider")) new core(".albums__slider", {
            ...
            if (document.querySelector(".events-item__media")) {
                let thumbsSwiper = new core(".mormorsgruvan-preview__slider", {
                    ...
                    navigation: {
                        prevEl: ".events-item__prev-mormorsgruvan",
                        nextEl: ".events-item__next-mormorsgruvan "
                    },
                    on: {}
                });
                new core(".mormorsgruvan-main__slider", {
                    modules: [ Navigation, Thumb, Controller ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
            ...
            if (document.querySelector(".events-item__media")) {
                let thumbsSwiper = new core(".norbergfestival-preview__slider", {
                    modules: [ Navigation, Thumb, Controller ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
                    ...
                    navigation: {
                        prevEl: ".events-item__prev-norbergfestival",
                        nextEl: ".events-item__next-norbergfestival"
                    },
                    on: {}
                });
                new core(".norbergfestival-main__slider", {
                    modules: [ Navigation, Thumb, Controller ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
            ...
            if (document.querySelector(".events-item__media")) {
                let thumbsSwiper = new core(".fylkingen-preview__slider", {
                    modules: [ Navigation, Thumb, Controller ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
                    ...
                    navigation: {
                        prevEl: ".events-item__prev-fylkingen",
                        nextEl: ".events-item__next-fylkingen"
                    },
                    on: {}
                });
                new core(".fylkingen-main__slider", {
                    modules: [ Navigation, Thumb, Controller ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
